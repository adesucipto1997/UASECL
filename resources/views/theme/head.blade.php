  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{{url('/kelas')}}"><i class="fa fa-file"></i> <span>Data Kelas</span></a></li>
        <li><a href="{{url('/siswa')}}"><i class="fa fa-file"></i> <span>Data Siswa</span></a></li>
        <li><a href="{{url('/logout')}}"><i class="fa fa-sign-out"></i> <span>Logout</span></a></li>
        @else
        <li><a href="{{url('/login')}}"><i class="fa fa-sign-in"></i> <span>Login</span></a></li>
        @endif
      </ul>
      <!-- /.sidebar-menu -->
    </section>
